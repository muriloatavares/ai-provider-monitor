    ...
    return (
      <div className="card text-center py-12">
        ...
        <p className="text-gray-400">
          No historical data available. Run benchmarks first.
        </p>
      </div>
    );
  }
      ...
      <div className="flex items-center gap-3 border-b border-[#45a29e]/20 pb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">
            Streaming benchmark visualization across models
          </p>
        </div>
      </div>

      <div className="flex gap-2 mb-6">
        <button className="px-3 py-1 text-xs font-medium bg-[#45a29e]/20 text-[#66fcf1] rounded border border-[#45a29e]/30">
          Latest Run
        </button>
        <button
          className="px-3 py-1 text-xs font-medium bg-[#1f2833] text-gray-400 rounded border border-[#1f2833] opacity-50 cursor-not-allowed"
          title="Requires SQLite (Phase 11)"
        >
          24h
        </button>
        <button
